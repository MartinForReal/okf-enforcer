...
- **Live check on save / open**, **Scan vault on startup**, **Fix format issues on save**, **Auto-generate index.md**, **Auto-migrate to latest OKF on fix** — automation toggles. A folder with something to list gets an `index.md`; an existing one is kept current as notes are added, renamed, and deleted.
